...
// N
	...
	/** Set CFDIFechaTimbrado.
		@param CFDIFechaTimbrado 
		CFDIFechaTimbrado
	  */
	public void setCFDIFechaTimbrado (String CFDIFechaTimbrado)
	{
		set_Value (COLUMNNAME_CFDIFechaTimbrado, CFDIFechaTimbrado);
	}

	/** Get CFDIFechaTimbrado.
		@return CFDIFechaTimbrado
	  */
	public String getCFDIFechaTimbrado () 
	{
		return (String)get_Value(COLUMNNAME_CFDIFechaTimbrado);
	}

	/** Set CFDI No Certificado SAT.
		@param CFDINoCertificadoSAT 
		CFDI No Certificado SAT
	  */
	public void setCFDINoCertificadoSAT (String CFDINoCertificadoSAT)
	{
		set_Value (COLUMNNAME_CFDINoCertificadoSAT, CFDINoCertificadoSAT);
	}

	/** Get CFDI No Certificado SAT.
		@return CFDI No Certificado SAT
	  */
	public String getCFDINoCertificadoSAT () 
	{
		return (String)get_Value(COLUMNNAME_CFDINoCertificadoSAT);
	}
	...
	/** Set CFDI Sello.
		...
		CFDI Sello
	  */
	public void setCFDISello (String CFDISello)
	{
		set_Value (COLUMNNAME_CFDISello, CFDISello);
	}

	/** Get CFDI Sello.
		@return CFDI Sello
	  */
	public String getCFDISello () 
	{
		return (String)get_Value(COLUMNNAME_CFDISello);
	}
	...
	{
		set_Value (COLUMNNAME_CFDISelloSAT, CFDISelloSAT);
	}

	/** Get CFDI Sello SAT.
		@return CFDI Sello SAT
	  */
	public String getCFDISelloSAT () 
	{
		return (String)get_Value(COLUMNNAME_CFDISelloSAT);
	}
